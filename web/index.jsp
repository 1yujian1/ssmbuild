...
<head>
    ...
    <title>CRM登陆</title>
    <link rel="stylesheet" href="common/lib/layui/css/layui.css" media="all"/>
...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
            <blockquote class="layui-elem-quote">HEBUT.石化设备企业CRM</blockquote>
        </div>
    </div>
</div>
<!-- Head End -->
...
<div class="zyl_lofo_main">
    <fieldset class="layui-elem-field layui-field-title zyl_mar_02">
        <legend>欢迎登陆 - 客户关系管理平台</legend>
    </fieldset>
    <div class="layui-row layui-col-space15">
        <form class="layui-form zyl_pad_01" action="">
            <div class="layui-col-sm12 layui-col-md12">
                <div class="layui-form-item">
                    <input id="userName" type="text" name="userName" lay-verify="required|userName" autocomplete="off" placeholder="账号" class="layui-input">
...
<!-- Layui Js -->
<script type="text/javascript" src="common/lib/layui/layui.js"></script>
<!-- Jqarticle Js -->
        ...
        form.on('submit(demo1)', function(data){
            $.ajax({
                ...
                success:function (data) {
                    if(data){
                        layer.msg("登陆成功")
                        window.location.href="${pageContext.request.contextPath}/account/toMain";
                    }else{
