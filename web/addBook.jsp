        ...
        <div style="padding: 15px;">
            ...
            <form action="${pageContext.request.contextPath}/book/addBook" method="post">
                <div class="layui-form">
                    ...
                    <input type="text" name="bookName" class="control-box" id="bkname" required>
                </div>
                <div class="layui-form">
                    <label >书籍数量：</label>
                    <input type="text" name="bookCounts" class="control-box"  required>
                </div>
                <div class="layui-form">
                    <label >书籍描述：</label>
                    <input type="text" name="detail" class="control-box"  required>
                </div>
                <div class="layui-form">
                    <input type="submit" class="control-box" value="添加" >
                </div>
            </form>
